...
export default function ProjectsStack() {
  return (
    <Stack.Navigator>
      ...
      <Stack.Screen name="Contratación" component={Contracting} />
      <Stack.Screen name="Infraestructura" component={Infraestructure} />
      <Stack.Screen name="Tecnología" component={Technology} />
      <Stack.Screen name="Talento Humano" component={HumanTalent} />
      <Stack.Screen
