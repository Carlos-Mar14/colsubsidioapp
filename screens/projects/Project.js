    ...
    <View style={styles.container}>
      <View style={styles.rowContainer}>
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate("Contratación", { projectId: id })}
        >
        ...
        <TouchableOpacity
          style={styles.btnSquare}
          onPress={() =>
            navigation.navigate("Infraestructura", { projectId: id })
          }
        >
      ...
      <View style={styles.rowContainer}>
        <TouchableOpacity
          style={styles.btnSquare}
          onPress={() => navigation.navigate("Tecnología", { projectId: id })}
        >
        ...
        <TouchableOpacity
          style={styles.btnSquare}
          onPress={() =>
            navigation.navigate("Talento Humano", { projectId: id })
          }
        >
      ...
      <View style={styles.rowContainer}>
        <TouchableOpacity
          style={styles.btnSquare}
          onPress={() =>
            navigation.navigate("Servicios Administrativos", { projectId: id })
          }
        >
