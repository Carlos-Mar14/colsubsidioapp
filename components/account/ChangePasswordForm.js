...
export default function ChangePasswordForm({ setShowModal, toastRef }) {
  ...
  const validateForm = () =>{
      ...
      if(size(newPassword) < 6 ){
        setErrorNewPassword("Debes ingresar una nueva contraseña, minimo 6 carácteres.")
        isValid = false
      }

      if(size(confirmPassword) < 6 ){
        setErrorConfirmPassword("Debes ingresar una confirmación de tu contraseña, minimo 6 carácteres.")
        isValid = false
      }
